...
# ╔═╡ dca10149-25fb-44da-8fd9-a72a8a73366b
# ╠═╡ disabled = true
#=╠═╡
let
	gr()
	plot_clustering_rst(data₄, K₄, truezs₄,  truemvns₄, trueπs₄)
	title!("Ground truth for dataset")
end;
  ╠═╡ =#
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "66bc5b006f2d6ac278a134c99ad6b84c2852c398"
