...
# ╔═╡ ba7c5db9-0bb7-46b4-95d9-d5b9e05a923b
md"""
...
* we use 1/5 of the total data as training
"""
...
# ╔═╡ 6db651e8-188b-499a-af99-aabe83a06b45
let
...
# ╔═╡ d051cb34-6944-4fc6-be77-9b4f5b88a2db
TwoColumn(md"""
\
\
...
# ╔═╡ f3af9e88-5926-4466-8b2b-b7a109bb700d
md"""
...
# ╔═╡ d3ce4f25-7ea6-4377-a422-3990ad217686
# using Functors
...
# ╔═╡ cde80506-b1c6-40ea-bec2-36d228088271
relu(x) = max(x, 0);

# ╔═╡ 82b55a33-a2f2-4be1-a45d-462a5d2a59d3
...
nnet_mnist = begin
	...
	for e in 1: epochs
		...
		while i < n_obs
			...
			xs, ys = train_mnist[:, i:j], train_mnist_ys_one_hot[:, i:j]
			∇gt = Zygote.gradient(() -> cross_en_loss(ys, nnet_mnist(xs)), Params(layers))
			for l in layers
				update!(l, ∇gt[l], -γ)
			end
			i = j + 1
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "c636325ee95e987a41e583cb26e5810fabf327b6"
