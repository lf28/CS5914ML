...
%    
    ...
    \begin{equation*}
 		\eqnmarkbox[WildStrawberry]{posterior}{p(H|\mathcal D)}\; \eqnmark[black]{propto}{\propto} \; \eqnmarkbox[NavyBlue]{prior}{p(H)} \; \eqnmarkbox[black]{likelihood}{p(\mathcal{D}|H)} %    \mathcal{O}\big(
 \end{equation*}
%
...
\annotate[yshift= -1.5em]{below,right}{propto}{proportional to}
...
\annotate[yshift=-1.5em]{below,left}{posterior}{Posterior}
