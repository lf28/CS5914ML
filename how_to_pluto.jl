...
# ╔═╡ a5761422-2d98-4e2c-ba9e-a1968b64a1de
# md"""
...
# ╔═╡ 7b538cb9-474d-46ea-8c9e-738891d11ed8
md"""

## Aside: `Julia` and `Pluto` notebook

$(Resource("https://julialang.org/assets/infra/logo.svg", :height=>40, :align=>:left))
\
\



##### [Julia](https://docs.julialang.org/en/v1/) is a general-purpose, open-source, dynamic, and high-performance language dedicated to machine learning


* easy to use like other script languages such as `R` and `Python` 
* but works as fast as C/Fortran
* completely optional for CS5914 but highly recommended for you to learn it
...
# ╔═╡ 0f97d54e-488d-4555-ad8c-e5c258d329eb

html"<center><img  src='https://julialang.org/assets/images/benchmarks.svg' width = '700' /></center>"


# ╔═╡ 39ab2812-fb5b-47b3-a91e-6dcd91f04d07
md"""

## Aside: how to run this notebook

`Pluto` is a programming environement for `Julia`

> It is highly recommended that you download the slides and run it locally while watching the lectures!


"""

# ╔═╡ 52dba302-f342-46e6-8403-cbb78fac7f8b
md"""
...
# ╔═╡ cea4f767-50d9-4e79-878e-8bae34cbb7cd
md"""
## Aside: how to run this notebook
...
# ╔═╡ 8ec8b494-fb25-4a34-abc4-732a4a2f7078
md"""
## Aside: how to run this notebook
...
##### Step 3. Run `Pluto` and play with the slides
```juliarepl
julia> using Pluto
julia> Pluto.run()
```
...
# ╔═╡ 2ae965a4-2bb6-42d8-9bb0-1a1143352823
md"""
## Aside: how to run this notebook
...
##### Step 4. Run the notebook file from the browser
